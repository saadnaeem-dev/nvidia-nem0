...
class SttEnFastConformerTransducerLarge(SttEnFastConformerCtcLarge):
    model_path: Optional[
        str] = r"C:\\Users\\saadn\\PycharmProjects\\Nvidia-Nemo-Models\\stt_en_fastconformer_transducer_large.nemo"  # Path to a .nemo file
...
class Stt_EnFastConformerTransducerLargeLs(SttEnFastConformerCtcLarge):
    model_path: Optional[
        str] = r"C:\\Users\\saadn\\PycharmProjects\\Nvidia-Nemo-Models\\stt_en_fastconformer_transducer_large_ls.nemo"  # Path to a .nemo file
...
class SttEnSqueezeFormerCtcMediumLs(SttEnFastConformerCtcLarge):
    model_path: Optional[
        str] = r"C:\\Users\\saadn\\PycharmProjects\\Nvidia-Nemo-Models\\stt_en_squeezeformer_ctc_medium_ls.nemo"  # Path to a .nemo file
...
class SttEnSqueezeFormerCtcSmallMediumLs(SttEnFastConformerCtcLarge):
    model_path: Optional[
        str] = r"C:\\Users\\saadn\\PycharmProjects\\Nvidia-Nemo-Models\\stt_en_squeezeformer_ctc_small_medium_ls.nemo"  # Path to a .nemo file
